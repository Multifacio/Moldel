...
exercise3_3 = Exercise(episode = 3, alive = alive3, maximum = None, earned = [
                            Earning(money = -2345, minor = {Player.ANNEMIEKE_16, Player.CECILE_16, Player.ELLIE_16,
...
alive7 = {Player.ANNEMIEKE_16, Player.KLAAS_16, Player.ROP_16, Player.TAEKE_16, Player.TIM_16}
...
exercise7_2 = Exercise(episode = 7, alive = alive7, maximum = 1000, earned = [
...
exercise8_1 = Exercise(episode = 8, alive = alive8, maximum = 2000, earned = [
                            Earning(money = 2000, major = {Player.TAEKE_16, Player.TIM_16}, minor = {Player.ANNEMIEKE_16,
                                Player.KLAAS_16}),
                        ])
exercise8_2 = Exercise(episode = 8, alive = alive8, maximum = 4500, earned = [
                            Earning(money = 202, major = {Player.ANNEMIEKE_16}),
                            Earning(money = 2506, major = {Player.TAEKE_16}),
                            Earning(money = -13, major = {Player.TAEKE_16, Player.TIM_16}, minor = {Player.ANNEMIEKE_16,
                                Player.KLAAS_16})
                        ])
exercise8_3 = Exercise(episode = 8, alive = alive8, maximum = 1250, earned = [
                            Earning(money = 1000, major = {Player.ANNEMIEKE_16}, minor = {Player.KLAAS_16,
                                Player.TAEKE_16, Player.TIM_16})
                        ])
...
season16 = Season([exercise1_1, exercise1_2, exercise2_1, exercise2_2, exercise3_1, exercise3_2, exercise3_3,
                   exercise4_1, exercise4_2, exercise4_3, exercise5_1, exercise5_2, exercise5_3, exercise6_1,
                   exercise6_2, exercise6_3, exercise7_1, exercise7_2, exercise8_1, exercise8_2, exercise8_3,
                   exercise9_1])
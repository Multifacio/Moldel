...
LINKER = {Player.CHARLOTTE_22: {"charlotte", "sjalotten", "charlot", "sjalot"},
          ...
          Player.EVELIEN_19: {"evelien", "evelyn", "eveline", "evelyne"},
          Player.EVI_19: {"evi", "evy", "evie"},
          Player.JAMIE_19: {"demi", "jamie", "jimmy"},
          Player.MEREL_19: {"merel", "merol"},
          Player.NIKKIE_19: {"nicky", "nikki", "nikkie", "pikkie", "wiki"},
          Player.NIELS_19: {"niels", "nielz"},
          Player.RICK_PAUL_19: {"paul"},
          Player.ROBERT_19: {"robert", "robèrt"},
          Player.SARAH_19: {"sarah", "sara", "saar", "zara", "zhara"},
          Player.SINAN_19: {"cena", "china", "sinan", "simon", "xenon", "sinar", "sinaï"},
          }
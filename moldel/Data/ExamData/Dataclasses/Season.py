...
class Season:
    ...
    Attributes:
        ...
        e - 1 < key <= e where e is the episode number of that episode in which these moments happen. The order of the
        moments happen: the earliest moment should get the lowest key and the latest moment should get the key value e.
        The values of this dict are Episode instances.
    """
    players: list
    episodes: dict
    ...
    def compute_distribution(self, predict_season: int, latest_episode: int, train_seasons: Set[int]) -> Dict[Player, float]:
        """ Compute the likelihood distribution which indicates how likely a player is the 'Mol'.
            ...
            Parameters:
                ...
                train_seasons (Set[int]): A set of season number (int) which are used for training this layer.

            Returns:
                Dict[Player, float]: A dictionary that contains the likelihood for each player that it is the 'Mol'.
                The key of this dictionary is the Player for which the likelihood is computed and the value is a float
                which indicates how likely the player is the 'Mol'.
        """
        pass
...
total_tasks = sum([SEASON_EXCEPTION.get(season, MAX_EPISODE) + 1 for season in VALIDATE_SEASONS])
...
for season in VALIDATE_SEASONS:
    ...
    for episode in range(SEASON_EXCEPTION.get(season, MAX_EPISODE) + 1):
